...
/**
    ...
    This extension adds some computed values and random values generation to the BodyMeasureReading class generated by Core Data.
*/
extension BodyMeasureReading {
    ...
    Based on [UK NHS](https://www.nhs.uk/common-health-questions/lifestyle/what-is-the-body-mass-index-bmi/) guidelines.
    ...
    /**
        Random constructor. Creates a body measure reading with gaussian random weight and height.
     */
    ...
    /**
     Represents the four average values of a list of blood pressure readings
     */
